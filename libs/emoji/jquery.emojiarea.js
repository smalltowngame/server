...
//                    range.insertNode(document.createTextNode(' '));
    ...
    //PATCH:
    window.emoji.EmojiArea = EmojiArea;
    ...
    EmojiArea_WYSIWYG.prototype.onChange = function () {
        ...
        //PATCH: update position to insert emojis (multiple emoji message)
    ...
    EmojiMenu.prototype.load = function () {
        ...
        for (var group in options) {
            ...
            groups.push('<a group="#group_' + group + '" class="tab_switch"><li>' + options[group]['name'] + '</li></a>');
