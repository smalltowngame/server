...
var lang = {
    ...
    NewCards: "New cards"
    ,
    newCardsHelp: "(say everyone look their cards)"
    ,
    ...
    ,
    AdminEndTurn: "Admin can and turn at any time"
    ,
    sec_p: "sec/p"
    ,
    //cards
    ...
    ,
    cleanHelp: "Any problem? let us know on 'sml.town'"
    ,
    //friends
    Friends: "Friends"
    ,
    ...
    Cancel: "Cancel"
    ,
    NoKills: "The village has not been agreed and no one been lynched"
    ,
    NoKillsTonight: "Everybody wakes up without kills."
    ,
    ...
    ,
    GoodMorning: "Good Morning! <p>(When the sun reaches the far right, the time will be over)</p>"
    ,
    ...
    GameOver: "GAME OVER"
    ,
    botsAdded: "There's not enought players, some bots have been added."
    ,
    ...
    openVotingEnabled: "open voting votes mode enabled"
    ,
    openVotingDisabled: "open voting votes mode disabled"
    ,
    adminEndTurnEnabled: "master now can end day turns"
    ,
    adminEndTurnDisabled: "master now can't end day turns"
    ,
    updatedDayTime: "updated day time"
    ,
    ...
    ,
    tutorialDone: "tutorial done" //TODO 
    ,
    gameNameAlreadyExists: "game name already exists" //TODO 
    ,
    spectatorMode: "click to join (spectator)" //TODO 
    ,
    gameNotPublic: "game not public" //TODO 
    ,
    isBot: "is bot"//TODO 
    ,
    ...
    ,
    someSpectator: "Some current spectators players won't play the game"
    ,
