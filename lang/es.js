//ANY LINE CAN BE TOTALLY EMPTY
var lang = {
    //INDEX ///////////////////////////////////////////////////////////////////
    //
    startingConnection: "iniciando conexión.."
    ,
    joiningGame: "uniéndote a la partida..."
    ,
    //GAME LIST TEXTS//////////////////////////////////////////////////////////
    GameList: "Game List:"
    ,
    ...
    ,
    hideGameSwipe: "Oculta la partida.. "
    ,
    ...
    Admin: "Master"
    ,
    adminHelp: "acciones admin"
    ,
    NewCards: "Repartir nuevas cartas"
    ,
    newCardsHelp: "(que todos miren sus cartas)"
    ,
    StartGame: "Empezar partida"
    ,
    startGameHelp: "(todo el pueblo se va a domir)"
    ,
    gameHelp: "opciones de juego"
    ,
    ...
    ,
    DayTime: "Duración del día / jugador"
    ,
    OpenVoting: "Permitir votos durante el día"
    ,
    AdminEndTurn: "Admin puede finalizar el turno de día"
    ,
    sec_p: "seg/p"
    ,
    //cards
    ...
    ,
    spectatorModeHelp: "permite ver y chatear sin jugar la partida"
    ,
    Image: "Imagen"
    ,
    VibrationStrength: "Intensidad de vibración"
    ,
    CleanErrors: "Limpiar errores"
    ,
    cleanHelp: "Algún problema? coméntanoslo en 'sml.town'"
    ,
    //friends
    Friends: "Amigos"
    ,
    friendsHelp: "encontrar amigos"
    ,
    Invite: "Invitar"
    ,
    inviteHelp: "invita amigos guardados"
    ,
    AddSocialId: "Añadir identificator"
    ,
    EditSocialId: "Editar identificador"
    ,
    addSocialIdHelp: "tu identificador permite ser encontrado por tus amigos"
    ,
    //info
    Info: "Información"
    ,
    ...
    Notes: "Notas"
    ,
    infoNotes: "guarda recordatorios para los siguientes turnos de juego"
    ,
    //back
    Back: "Atrás"
    ,
    ...
    //
    //HEAD STATUS GAME    
    newCards: "incluye nuevas cartas"
    ,
    waitingNewGame: "esperando nueva partida"
    ,
    gameRestarted: "La partida se ha reiniciado"
    ,
    noName: "no se ha encontrado un nombre"
    ,
    waitPlayersVotes: "esperando resto de votos"
    ,
    nightTime: "de noche"
    ,
    dayTime: "de día"
    ,
    wakingUp: "esperando jugadores que despierten"
    ,
    //
    //PLAYER LIST
    waiting: "esperando para jugar"
    ,
    ...
    dead: "muerto"
    ,
    morePlayers: "llamar a más jugadores"
    ,
    morePlayersHelp: "mínimo 4 jugadores para jugar"
    ,
    ...
    Cancel: "Cancelar"
    ,
    NoKills: "El pueblo no se ha puesto de acuerdo y nadie a sido linchado"
    ,
    ...
    ,
    //game events
    noCard: "todavía no tienes carta"
    ,
    //player list events    
    ...
    ,
    duplicatedUserName: "este nombre ya existe en la partida!"
    ,
    cannotCardsGame: "no puedes cambiar las cartas en medio de una partida"
    ,
    cannotCardsAdmin: "solo el admin puede cambiar las cartas de juego"
    ,
    //
    //SOCIAL
    //invite 
    ...
    Share: "Compartir!"
    ,
    ShareBy: "Compartir con:"
    ,
    //
    //HELP
    help_typeNameGame: "Escribe un nombre de partida de mínimo 3 carácteres."
    ,
    help_createGame: "Haz click en 'crear partida'"
    ,
    //
    //ERRORS
    ...
    ,
    tutorialQuestion: "Quieres aprender a jugar siguiendo un tutorial?"
    ,
    FORUM: "FORUM"
    ,
    androidAppQuestion: "abrir con la aplicacion android?"
    ,
    restartGameQuestion: "reiniciar partida?"
    ,
    playGameQuestion: "Quieres unirte a esta partida? <br/> (ahora estás en modo espectador)"
    ,
    restartGame: "reiniciar partida"
    ,
    startGame: "empezar partida"
    ,
    nightSelect: "seleccion nocturna"
    ,
    cannotEmpty: "no puede estar vacío!"
    ,
    tutorialDone: "tutorial completado" //TODO 
    ,
    gameNameAlreadyExists: "el nombre de partida ya existe" //TODO 
    ,
    spectatorMode: "haz click para unirte (espectador)"//TODO 
    ,
    gameNotPublic: "la partida no es pública" //TODO 
    ,
    isBot: "es bot"
    ,
    friendAdded: "friend added"
    ,
    OrCopyLink: "..o copia y comparte este link: "
    ,
    cantPlaySpectator: "no puedes añadirte a la partida si ya ha empezado!"
    ,
    ...
    ,
    shareThisError: "Por favor comunícanos este error en nuestra página web 'sml.town', gracias."
    ,
    lookingGames: "buscando partidas.."
};
