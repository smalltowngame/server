...
<html>
    <head>        
        ...
        <script type="text/javascript" src="<?php echo $smalltownURL ?>libs/smltown_errorLog.js"></script>
        ...
        <link rel='stylesheet' href='<?php echo $smalltownURL ?>css/help.css'>
    ...
    <body id="smltown">
        ...
        <div id='smltown_loader'>
            <img class="smltown_loadingIcon" src="img/loader.gif">
            <p id="smltown_textLoader"></p>
        </div>
    </body>
...
//    })();
    ...
    <script type="text/javascript" src="<?php echo $smalltownURL ?>js/Help.js"></script>
