    ...
    <body>
            ...
            <div id="menuContent">
                <div>
                    ...
                    <div class="selector">
                        ...
                        <div id="vibrationStrength" class="input device">                    
                            <span>VibrationStrength</span>
                            <form>
                                <input type="text" class="strength" placeholder="1"/>
                            </form>					
                        </div>
        ...
        <script>
            ...
            function runCountdown() {
                ...
                //external control contdown time
//                Game.countdownCorrector = setInterval(function() {
//                    Game.countdown = (Game.time - (Date.now() / 1000)) | 0; //remove decimals
//                },60000); //every min
...
//                        Game.countdown = 0;
            ...
            function update(res) { //response
                ...
                if (res.game) { // GAME
                    if (res.game.chat) {
                        $("#console .text").html(res.game.chat);
                        chatUpdate();
                        setUserNamesByClass();
                    }
                    if (!Game.info.cards) {
